(function() {
    ...
    PersonDialogController.$inject = ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Person', 'Organization'];

    function PersonDialogController ($scope, $stateParams, $uibModalInstance, entity, Person, Organization) {
        var vm = this;
        vm.person = entity;
