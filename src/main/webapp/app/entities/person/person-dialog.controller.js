(function() {
    ...
    PersonDialogController.$inject = ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Person'];

    function PersonDialogController ($scope, $stateParams, $uibModalInstance, entity, Person) {
        var vm = this;
        vm.person = entity;
        vm.load = function(id) {
